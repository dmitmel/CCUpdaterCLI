...
func printHelp() {
	...
	fmt.Println("    --force : ignores dependencies")
	fmt.Println("  installfrom <path...> Installs one or more packages from .ccmod files")
	fmt.Println("    --online : downloads dependencies if required")
	fmt.Println("    --force : ignores dependencies")
	fmt.Println("  uninstall <name...>   Uninstall one or more packages")
	fmt.Println("    --force : ignores dependent packages")
	fmt.Println("  update [name...]      Updates one or more packages")
	fmt.Println("    --force : ignores dependencies / dependent packages")
